    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navigation" data-nav-image="./img/blurred-image-1.jpg">
            ...
            <ul class="navbar-nav ml-auto">
                @guest
                <li class="nav-item">
                    <a class="nav-link" rel="tooltip" title="Latest Articles" data-placement="bottom" href="{{ route('blog') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link" rel="tooltip" title="Sign In" data-placement="bottom" href="{{ route('login') }}">
                        <i class="fa fa-sign-in" aria-hidden="true"></i>
                        <p>{{ __('Login') }}</p>
                    </a>
                </li>
               <li class="nav-item">
                    <a class="nav-link" rel="tooltip" title="Register - Sign Up" data-placement="bottom" href="{{ route('register') }}">
