                    ...
                    <li class="nav-item dropdown">
                        <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                            <img class="mr-1 grav-img" src="{{ Gravatar::get(Auth::user()->email) }}" alt="{{ Auth::user()->username }}">
                            <p>{{ Auth::user()->username }}</p> <span class="caret"></span></a>

                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="{{ route('dashboard') }}"><i class="fa fa-user-circle-o" aria-hidden="true"></i>
                                <p> {{ __('Dashboard') }}</p></a>
                            @role('admin')
                            <a class="dropdown-item" href="{{ route('admin') }}"><i class="fa fa-unlock-alt" aria-hidden="true"></i>
