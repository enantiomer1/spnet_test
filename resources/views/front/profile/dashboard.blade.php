                ...
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item">
                                <a href="#edit" class="nav-link" aria-controls="edit" role="tab" data-toggle="tab">{{ __('labels.edit') }}</a>
                            </li>

                            
                            <li class="nav-item">
                                <a href="#password" class="nav-link" aria-controls="password" role="tab" data-toggle="tab">{{ __('navs.change_password') }}</a>
                            </li>
                        </ul>
